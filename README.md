...
- [**codebase-memory-mcp**](https://github.com/DeusData/codebase-memory-mcp) (3.0k ⭐) - MCP server that indexes a codebase into a persistent knowledge graph. 159 languages, sub-ms structural queries, ~99% fewer tokens than file-by-file exploration. Single static binary (pure C, zero dependencies) with 14 MCP tools for call-graph tracing, dead-code detection, cross-service HTTP linking, Cypher queries, architecture overview, and auto-sync.
