...
- [**kodo**](https://github.com/ikamensh/kodo) (37 ⭐) - Autonomous multi-agent coding orchestrator that runs overnight on Claude Code Max, directing agents through work cycles with independent verification to produce tested, reviewed code.
