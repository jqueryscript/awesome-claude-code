...
- [**claude-memory-skill**](https://github.com/hanfang/claude-memory-skill): Minimal, low-friction hierarchical memory system for Claude Code with background agents and filesystem-based persistence.
