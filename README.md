...
- ✨ [**Ivy Tendril**](https://github.com/Ivy-Interactive/Ivy-Tendril) (106 ⭐) - Open-source AI coding orchestrator that manages Claude Code (and Codex, Antigravity, Copilot, OpenCode) through a plan-based lifecycle with verification gates, self-improving memory, and human-in-the-loop checkpoints.
