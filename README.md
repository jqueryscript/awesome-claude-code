...
- [**RondoFlow**](https://github.com/rondoflow/rondoflow) - (13 ⭐) - Local-first visual platform for orchestrating teams of Claude Code agents on a drag-and-drop canvas, connecting skills, MCP tools, and safety policies, with a Director that steers the run mid-execution and a Planner and Advisor that tune the team before and after.
