...
- [**j4rk0r/claude-skills**](https://github.com/j4rk0r/claude-skills): Three expert-grade skills -- skill-guard (9-layer security auditor for skills/plugins), skill-advisor (smart routing with gap analysis), and skill-learner (persistent error correction). MIT licensed, A+ 120/120.
