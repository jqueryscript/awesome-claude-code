...
- [**MyVibe**](https://www.myvibe.so): Instant publishing skill for Claude Code. Type `/myvibe:publish` to deploy projects to live URLs in seconds. Auto-detects project type (HTML, Vite, React, Next.js) and handles builds automatically.
