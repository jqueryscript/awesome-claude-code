...
- [**pluribus**](https://github.com/caioribeiroclw-pixel/pluribus) (6 ⭐) - Cross-tool context handoff CLI for Claude Code, Cursor, Codex, OpenClaw, and other coding agents; emits receipts for loaded rules, drift, and handoff state.
