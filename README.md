...
- [**claude-code-coach**](https://github.com/jonathanlesh/claude-code-coach) - A subagent and best practices guide for turning lessons, corrections, and workflows into the right `.claude/` artifacts. Includes a coach agent that recommends artifact types and a comprehensive reference guide.
