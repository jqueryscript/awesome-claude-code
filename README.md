...
- [**Governor**](https://github.com/0xhimanshu/governor): Claude Code usage governor with compact output, safe CLAUDE.md compression, noisy-log filtering, local telemetry, and drift guardrails.
