...
- 🌟 [**MoAI-ADK**](https://github.com/modu-ai/moai-adk) (937 ⭐) - SPEC-first multi-agent orchestration kit for Claude Code with 24 specialized agents across 8 domains (backend, frontend, security, testing, docs, design, UX, devops). Enforces Plan → Run → Sync workflow with TRUST 5 quality gates, Agent Teams parallel execution, and 16-language project support.
