...
- [**CLAUDE.md Auditor**](https://github.com/novadyne-hq/claudemd-auditor-skill): Drop-in Claude Code skill that audits your CLAUDE.md file with calibrated 0–100 scoring across 6 axes (structure, specificity, safety, and more) plus concrete fixes for each finding.
