...
- [**claude-dash**](https://github.com/krabat-l/claude-dash): Real-time statusline plugin for Claude Code showing context health, quota, cost, cache efficiency, tool activity, and task progress.
