...
- [**contextrot**](https://github.com/Priyanshu-byte-coder/contextrot) - (18 ⭐) - Measure where your coding agent starts degrading: failure-signal rate vs context fill from your local Claude Code and OpenCode transcripts, with confidence intervals. Nothing uploaded.
