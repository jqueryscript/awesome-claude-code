...
- [**ccwaste**](https://github.com/PeterAshraf1/ccwaste) - (0 ⭐) - Audits local Claude Code transcripts to show which specific tool calls wasted tokens, including the carry cost of output that is re-read on every later turn of a session.
