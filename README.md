...
- 🔥 [**claude-octopus**](https://github.com/nyldn/claude-octopus) (2.1k ⭐) - Multi-LLM orchestration plugin for Claude Code. Dispatches tasks across 8 providers (Codex, Gemini, Copilot, Qwen, Ollama, Perplexity, OpenRouter, OpenCode) with model family diversity, consensus gates, and Double Diamond workflows. 47 commands, 50 skills, 32 personas.
