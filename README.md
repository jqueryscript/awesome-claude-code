...
- [**CompozyOS**](https://github.com/compozy/compozy) - (2.4k ⭐) - Web shell and local daemon that run Claude Code as a team of agents on loops and schedules, with shared memory and approvals.
