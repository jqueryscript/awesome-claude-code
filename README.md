...
- [**cross-session-handle**](https://github.com/Reimy456/cross-session-handle) - (1 ⭐) - Session continuity for Claude Code: deterministic transcript capture before every context compaction, LLM-verified handoffs that hunt silent renouncements, and post-compaction re-anchoring.
