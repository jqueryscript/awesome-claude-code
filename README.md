...
- [Mysti](https://github.com/DeepMyst/Mysti) - Multi-agent AI coding assistant for VS Code with Claude Code integration, brainstorm mode, and multi-provider support.
