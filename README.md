...
- [**BurnRate**](https://github.com/burnrate-dev/burnrate) - AI coding cost analytics CLI that tracks usage and spend across Claude Code, Cursor, Copilot, Windsurf, Aider, Cline, and Codex with 46 optimization rules.
