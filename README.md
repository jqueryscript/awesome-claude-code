...
- [**pluribus**](https://github.com/caioribeiroclw-pixel/pluribus) (6 ⭐) - npm-runnable context handoff CLI for Claude Code, Cursor, Codex, OpenClaw, and other coding agents; syncs shared rules and emits evidence receipts for context drift, handoffs, and sufficiency checks.
