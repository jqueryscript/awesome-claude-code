...
- [**menhera-loop**](https://github.com/Borelchu/menhera-loop) - A menhera-style completion gate that blocks Claude Code from declaring "done" until requirements, green test runs, and leftover TODOs are verified from the session transcript.
