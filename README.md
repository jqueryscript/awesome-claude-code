...
- [**Claude-Software-Office**](https://github.com/ilkerprdal/Claude-Software-Office) (0 ⭐) - 11 specialized agents (PM/Architect/Devs/QA/Security/Scrum) and 20 commands for full Agile workflow. Single-file Windows installer, multilingual (auto-detects user language and responds accordingly), built-in `/takeover` to import context from prior AI tools (Cursor, Copilot, Windsurf, etc.).
