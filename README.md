...
- [**telegram-ai-bridge**](https://github.com/AliceLJY/telegram-ai-bridge) - Run N parallel Claude Code sessions from your phone via Telegram. War Room mode, per-bot personas, A2A multi-agent collaboration, and tool approval from phone.
